...
from transformers import AutoProcessor, AutoTokenizer, AutoImageProcessor, AutoModelForCausalLM, \
    BlipForConditionalGeneration, Blip2ForConditionalGeneration, VisionEncoderDecoderModel
import torch
import open_clip
...
def generate_captions(image):
    ...
    # caption_blip2_8_bit = generate_caption(blip2_processor_8_bit, image, use_float_16=True).strip()

    return caption_git_large_coco, caption_git_large_textcaps, caption_blip_large, caption_coca


examples = [["cats.jpg"], ["stop_sign.png"], ["astronaut.jpg"]]
outputs = [gr.outputs.Textbox(label="Caption generated by GIT-large fine-tuned on COCO"),
           ...
           gr.outputs.Textbox(label="Caption generated by CoCa")]
